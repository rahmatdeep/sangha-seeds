...
export default function ProfilePage() {
  ...
  return (
    ...
    >
      {/* Changed max-width for desktop and added grid wrapper */}
      <div className="max-w-md lg:max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6 items-stretch">
          ...
          {/* RIGHT COLUMN - Warehouse & Additional Details */}
      ...
      {/* Member since - centered below the grid */}
      <p
        className="text-center text-xs mt-8 opacity-50"
        style={{ color: theme.colors.primary }}
      >
        Member since{" "}
        {user.createdAt
